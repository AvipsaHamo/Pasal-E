...
public class InventoryRepository : IInventoryRepository
{
    ...
    public Task<Product?> GetProductByIdAsync(int productId, int shopId) =>
        _db.Products.FirstOrDefaultAsync(p =>
    ...
    // ✅ NEW BULK METHOD (this replaces loop inserts)
    public async Task CreateVariationsBulkAsync(List<Variation> variations)
    {
    ...
    public Task<Variation?> GetVariationByIdAsync(int variationId, int productId) =>
        _db.Variations.FirstOrDefaultAsync(v =>
